...
config :uno, UnoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1+uwqiP4XynJIL0ZvXNZNxJqHQeXBSdlhLcitZiIgE1Hp5MUmn2IfSKgZXSn2Fne",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:uno, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:uno, ~w(--watch)]}
  ]
